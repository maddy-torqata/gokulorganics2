								...
								<div className="footer-wrapper pl-45 mb-30">
									...
									<ul className="fotter-link">
										...
										<li>
											...
											<span>gokulorganics@gokulorganics.com</span>
										</li>
										<li>
											<i><FontAwesomeIcon icon={['far', 'headphones']}/></i>
											<span>Devender Venigalla - Managing Partner: +91 9440237577</span>
											<i><FontAwesomeIcon icon={['far', 'headphones']}/></i>
											<span>Mohan Venigalla    -  Managing Partner: +91 9912771971</span>
										</li>
									</ul>
								</div>
							</div>
